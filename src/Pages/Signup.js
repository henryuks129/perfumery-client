...
function handlePost(e){
  e.preventDefault();
  axios.post('https://perfumery-server.onrender.com/auth/register')
}
const Signup = () => {
  ...
  return (
    <div className='mb-5'>
      ...
      <form action='' method='POST' onSubmit={handlePost(submitForm)}>
      ...
      <button onClick={()=>{navigate('/Signin')}} className='signup-button border-0'>Create Account</button>
    {/* <div className='legal-statement-body'>
